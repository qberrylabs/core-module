        ...
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                {!! Form::model($fee, ['method' => 'PATCH','route' => ['admin.deposit.fees.update', $fee->id]]) !!}
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Payment Methods :</strong>
                            <select  class="form-control select-builder" id="fee_input_name" data-width="100%" name="payment_method" required="required" >
                                <option></option>
                                @foreach ($paymentMethods as $paymentMethod)
                                <option  value="{{ $paymentMethod->name }}" @if ( $paymentMethod->name == $fee->payment_method) selected @endif> {{ $paymentMethod->name }}</option>
                                @endforeach
                            </select>
