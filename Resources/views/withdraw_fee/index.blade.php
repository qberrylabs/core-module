        ...
        <div class="col-md-12 col-sm-12 ">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              @include('coremodule::withdraw_fee.create')
              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody id="fees_items">
                    ...
                    <tr class="fee_{{ $fee->id }} ">
                        ...
                        <td>
                            @can('fee-edit')
                            <a class="btn btn-primary" href="{{ route('admin.withdraw.fees.edit', ['id'=>$fee->id]) }}">Edit</a>
                            @endcan

                            <a href="{{ route('admin.withdraw.fees.destroy', ['id'=>$fee->id]) }}" class="btn btn-danger">Delete</a>
